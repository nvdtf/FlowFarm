...
pub contract StrawberrySeeds: FungibleToken {
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance {
        ...
        pub fun deposit(from: @FungibleToken.Vault) {
            let vault <- from as! @StrawberrySeeds.Vault
        ...
        destroy() {
            if self.balance > 0.0 {
                StrawberrySeeds.totalSupply = StrawberrySeeds.totalSupply - self.balance
            }
        }
    ...
    pub resource Minter {
        ...
        ///
        pub fun mintTokens(amount: UFix64): @StrawberrySeeds.Vault {
            pre {
                amount > 0.0: "Amount minted must be greater than zero"
                amount <= self.allowedAmount: "Amount minted must be less than the allowed amount"
            }
            StrawberrySeeds.totalSupply = StrawberrySeeds.totalSupply + amount
    ...
    init() {
        ...
        self.account.link<&StrawberrySeeds.Vault{FungibleToken.Balance}>(
